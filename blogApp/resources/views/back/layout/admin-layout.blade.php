        ...
        <div class="menu-block customscroll">
            <div class="sidebar-menu">
                <ul id="accordion-menu">
                    ...
                    {{-- Home --}}
                    <li class="dropdown">
                        <a href="{{ route('admin.admin-dashboard') }}" class="dropdown-toggle no-arrow {{ Route::is('admin.admin-dashboard') ? 'active' : '' }}">
                    ...
                    <li>
                        <a href="{{ route('admin.users-list') }}"
                            class="dropdown-toggle no-arrow {{ Route::is('admin.users-list') ? 'active' : '' }}">
                            <span class="micon">
                    ...
                    {{-- users posts list --}}
                    <li>
                        <a href="{{ route('admin.users-posts') }}"
                            class="dropdown-toggle no-arrow {{ Route::is('admin.users-posts') ? 'active' : '' }}">
                            <span class="micon">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
