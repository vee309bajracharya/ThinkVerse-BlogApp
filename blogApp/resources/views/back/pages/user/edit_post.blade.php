...
@section('content')
    ...
    {{-- form starts here --}}
    <form action="{{route('user.update_post',['post_id'=>$post->id])}}" method="POST" autocomplete="off" enctype="multipart/form-data" id="updatePostForm">
        @csrf
        <section class="row">
                ...
                <section class="card card-box my-2">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="content" id="content" cols="30" rows="10" class="ckeditor form-control" placeholder="Enter post content">
                                {!! $post->content !!}
                            </textarea>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="form-group mt-4">
                                ...
                                <textarea name="meta_description" id="" cols="30" rows="10" class="form-control" placeholder="Enter post meta description">
                ...
                <section class="card card-box mb-2">
                    <section class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="featured_image" id="featured_image_input" class="form-control-file form-control" height="auto">
